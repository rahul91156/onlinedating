...
//            //}
    ...
    function get_conversation_list($accepted = 1) {
        ...
        $conversations      = ToObject($messages->getConversationList());
        $OnlineUsers        = 0;
        $conversations_html = '';
        $mode               = route(4);
        ...
        if($notification) {
            ...
            if ($status == true) {
                ...
                if($Notif) {
                    ...
                    $Notif->createNotification('', $to,$from, 'accept_chat_request', '', '/@' . $username . '/chat_request');
                }
        ...
        if( $uid > 0 ){
            ...
            if ($status == true) {
                ...
                if($Notif) {
                    ...
                    $Notif->createNotification('', (int)self::ActiveUser()->id, $to, 'decline_chat_request', '', '/@' . $username);
                }
